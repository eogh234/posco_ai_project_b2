...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default='/home/piai/바탕화면/YOLO trial(1)/VideoFile/IMG_2581.MOV', help='file/dir/URL/glob, 0 for webcam')
...
get_ipython().system("python detect_jihyun.py --weight './runs/train/exp/weights/best.pt' --source '/home/piai/바탕화면/YOLO trial(1)/VideoFile/IMG_2581.MOV' --conf 0.6")
